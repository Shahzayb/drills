...
set* is the shared contract; it is documented in `drills/06-request-tracing-and-structured-logs.md`
...
`drills/06-writeup-worksheet.md`; this is the record of what was decided by measuring.
